...
var Gauge = function(id, value, gaugeMaxValue, unit, margin) {
    ...
    Needle.prototype.moveTo = function(maxValue, perc, unit) {
        var self,
            ...
            .tween('progress', function() {
                return function(percentOfPercent) {
                    ...
                    valueText
                        ...
                        .text(Math.round(maxValue * progress) + unit)
    ...
    needle.render();
    needle.moveTo(gaugeMaxValue, percent, unit);
